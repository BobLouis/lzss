...
# addr_8 ~ addr_22, N=0~4:
    for N in range(5):
        ...
        # Check addr_(9+N*3)
        if np.all(data_2d[143+N*20] == 0):
            data_2d[9+N*3, 4:] = data_2d[8+N*3, 0]
            dont_care_bit += 4
        ...
        if np.all(data_2d[153+N*20] == 0):
            data_2d[9+N*3, :4] = data_2d[9+N*3, 4]
            dont_care_bit += 4
    ...
    for n in range (23, 143):
        data_2d[n,7] = data_2d[n-1,0]
        data_2d[n,3] = data_2d[n,4]
    dont_care_bit += 240
